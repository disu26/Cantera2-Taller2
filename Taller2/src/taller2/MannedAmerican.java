...
/**
 * Clase nave tripulada lanzada desde EEUU, esta es una clase que se extiende de la clase nave espacial.
 * @author Dímar Andrey Suárez Hidalgo
 */
public class MannedAmerican extends SpaceShip{
    /**
     ...
     */
    public MannedAmerican(String name, float speed) {
        super(name, speed);
        this.launchingCountry = "USA";
    }
